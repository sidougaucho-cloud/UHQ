...
# ================== TOKEN ==================
TOKEN = "8981227915:AAGt_Aimvc1UZQRJw9jt_5lAXMyq3AVR9T4"   # ← Remplace par ton vrai token
...
def callback_handler(call):
    ...
    if data == "cat_tech":
        ...
        bot.send_message(chat_id, f"Tu as sélectionné : **{data}**\n\nContacte le support pour le prix et paiement.", parse_mode="Markdown")
    
    elif data == "support":
        bot.send_message(chat_id, "🆘 **Support** :\n@keyzer135 (ou ton username)")
