...
def callback_handler(call):
   try:
       ...
       if data == "cat_tech":
           bot.edit_message_text("🛒 **Catégorie Tech**", chat_id, call.message.message_id, reply_markup=tech_menu(), parse_mode="Markdown")
       elif data == "cat_fournisseur":
           bot.edit_message_text("📦 **Catégorie Fournisseur**", chat_id, call.message.message_id, reply_markup=fournisseur_menu(), parse_mode="Markdown")
       elif data == "back_main":
           bot.edit_message_text("🔥 **Menu Principal**", chat_id, call.message.message_id, reply_markup=main_menu(), parse_mode="Markdown")
...
if __name__ == "__main__":
   ...
   bot.infinity_polling(none_stop=False, timeout=60, long_polling_timeout=60)
