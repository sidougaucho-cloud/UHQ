...
N’hésitez pas à consulter notre catalogue ou à nous écrire pour toute question, nous vous répondons rapidement !
🆘 SAV : @UHQ_7500
...
def callback_handler(call):
    ...
    bot.answer_callback_query(call.id)   # ← CORRECTION AJOUTÉE ICI (LIGNE UNIQUE)
